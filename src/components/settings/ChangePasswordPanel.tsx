      ...
      <form onSubmit={submit} className="space-y-3 max-w-sm">
        <div>
          ...
          <input
            ...
            placeholder="••••••••"
            className="w-full bg-surface border border-default rounded-lg px-3 py-2 text-sm text-primary placeholder:text-muted focus:outline-none focus:border-ember-400/50 focus:ring-1 focus:ring-ember-400/30 transition-colors"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-ember-400 hover:bg-ember-500 disabled:opacity-50 disabled:cursor-not-allowed text-[#09090B] text-xs font-semibold px-4 py-2 rounded-lg transition-colors"
        >
