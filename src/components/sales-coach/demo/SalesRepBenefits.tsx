...
const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    body: "Six skills, scored out of ten from real calls: talk/listen (talking more lowers it — the skill is listening), tone, speed of speech, questions, objection handling, and closing. Each rep is measured against a competent-call standard and their own trend, never stack-ranked against each other. A skill with no data reads '—', never a fake zero.",
