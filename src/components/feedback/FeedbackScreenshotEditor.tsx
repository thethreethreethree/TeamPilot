      ...
      <div className="flex flex-wrap items-center justify-between gap-2 px-4 py-3 border-b border-default bg-base">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 text-xs px-2.5 py-1.5 rounded-lg border transition-colors ${
                  active
                    ? "border-brand bg-[#C8232C]/15 text-brand"
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-[#C8232C] hover:bg-[#A91D24] disabled:opacity-50 text-white font-semibold"
          >
  ...
  return (
    <>
      <textarea
        ...
        className="absolute bg-[#C8232C] text-white font-bold rounded-md outline-none resize-none ring-2 ring-white shadow-lg placeholder:text-white/70"
        style={{
          left,
          top,
          fontSize: `${fontPx}px`,
      ...
      <button
        ...
        className="absolute bg-white text-[#C8232C] rounded-full shadow-lg ring-2 ring-white hover:bg-emerald-50 flex items-center justify-center"
        style={{
          left: left - 14,
          top: top - 14,
          width: 28,
