...
import { CalendarDays, Users, Upload, CalendarClock, ShieldCheck, CalendarPlus, Settings, Sparkles } from "lucide-react";
...
const TABS = [
  { href: "/dashboard/schedule/assistant", label: "AI Assistant", icon: Sparkles },
  ...
  { href: "/dashboard/schedule/settings", label: "Settings", icon: Settings },
] as const;
