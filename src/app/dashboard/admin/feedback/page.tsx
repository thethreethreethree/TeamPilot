...
const STATUS_COLORS: Record<FeedbackStatus, string> = {
  ...
  in_progress: "border-[#C8232C]/40 bg-[#C8232C]/10 text-brand",
            ...
            {(
              ...
              <button
                ...
                className={`text-[11px] px-2.5 py-1 rounded-lg border transition-colors ${
                  statusFilter === s
                    ? "border-brand bg-[#C8232C]/8 text-brand"
        ...
        <div className="mt-3 pt-3 border-t border-default space-y-3">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-surface border border-default rounded-lg px-3 py-2 text-xs text-primary placeholder:text-muted focus:outline-none focus:border-[#C8232C]/50 focus:ring-1 focus:ring-[#C8232C]/30 resize-none mb-2"
            />
