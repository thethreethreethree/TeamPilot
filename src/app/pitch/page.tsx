          ...
          <div className="space-y-3">
            {[
              ...
              <div key={title} className="glass-card p-4 flex gap-4">
                <div
                  aria-hidden="true"
                  className="w-9 h-9 rounded-lg bg-ember-400/15 border border-ember-400/30 text-brand text-sm font-bold flex items-center justify-center flex-shrink-0"
                >
                  {i + 1}
                </div>
                <div>
...
function SizeFit({
  ...
  return (
    <div className="glass-card p-4 flex items-start gap-4">
      <div
        aria-hidden="true"
        className="w-10 h-10 rounded-lg bg-ember-400/15 border border-ember-400/30 text-brand flex items-center justify-center flex-shrink-0"
      >
  ...
  return (
    <div className="glass-card p-4 text-left">
      <div className="flex items-center gap-2 mb-2">
        <div
          aria-hidden="true"
          className="w-6 h-6 rounded-full bg-ember-400/15 border border-ember-400/30 text-brand text-xs font-bold flex items-center justify-center"
        >
          {n}
        </div>
