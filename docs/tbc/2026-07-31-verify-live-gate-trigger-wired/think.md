...
[
  ...
  { "id": "§3.2",   "read_at": "2026-07-31T11:45:00Z", "source_file": "CLAUDE.md", "line_range": "247-256", "why_it_governs": "The understanding gate is structural, not optional — a guard that reports it healthy while the trigger is un-wired defeats the constitutional interrupt.", "how_this_build_will_embody_it": "The check asserts the trigger runs the gate fn BEFORE INSERT OR UPDATE on problems." },
