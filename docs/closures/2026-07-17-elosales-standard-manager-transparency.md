...
| **AMD-004** | 05:01 | **CONFIRMATORY.** §1.7's derivation is faithful (one trivial drop: *"before acceptance"*). Bounds the lossy-derivation class to AMD-006 alone. |
