...
insert into fin_customers (id, company_id, name) values ('00000000-0000-0000-0000-00000000cu01','00000000-0000-0000-0000-0000000000c1','Beta Corp') on conflict (id) do nothing;
do $$ begin
  ...
  begin
    insert into fin_invoices (id, company_id, customer_id, invoice_number, invoice_date)
      values ('00000000-0000-0000-0000-0000000in01','00000000-0000-0000-0000-0000000000c1','00000000-0000-0000-0000-00000000cu01','INV-1','2026-07-15');
