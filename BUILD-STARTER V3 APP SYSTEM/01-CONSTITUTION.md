# The Constitution — governing rules for this build

> **Assembled from:** THINKX1.md (the complete, amended constitution) + the
> Methodology Asset Library (A1–A22) from THINKX2.md. `WEbCLAUDE.md` was
> byte-identical to THINKX1 and is therefore already included. THINKX2s own
> constitution section (its §0–§6) is an earlier, leaner edition fully superseded
> by THINKX1s §0–§7 below, so it is not duplicated. Nothing was dropped.

---

# PART 1 — THE CONSTITUTION (from THINKX1.md)
...
# PART 2 — THE METHODOLOGY ASSET LIBRARY (A1–A22, from THINKX2.md)
