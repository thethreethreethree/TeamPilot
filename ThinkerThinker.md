...
## A37 · CLAUDE.md is a DERIVATION, and a derivation can lose the force of the amendment it derives from — reading the derived rule faithfully is not reading the law

**Tags:** §7.3's own admission · the summary that reads complete · third altitude of A19/A35 (not-reading → reading-the-wrong-artifact) · bounded 1-of-4 · founder's explicit instruction, missed
**Captured:** 2026-07-17

**Context.** The founder's terms for the ELOSALES build were explicit: *"Quote the specific clauses of ThinkerThinker.md and Claude.md **including AMD-006 in full**."* I quoted **CLAUDE.md §1.5.1** — the four-layer framework — and treated that as having done it. §1.5.1 is ~40 lines. **AMD-006 is 254.** I never opened it.

§1.5.1 is not wrong. It names all four layers, in order, with the right definitions, and it says *"the order is a sieve"* about severity. What it does **not** carry is the amendment's operative verdict, in its Addendum: ***"A build that passes layer 4 but fails any of 1–3 is NOT shippable, regardless of surface quality."***

I read §1.5.1 — it is injected into context every session, so I read it *many* times — and shipped a **Layer-2 break** (a recordings feature no human can hear) while treating the four layers as a **review lens**. They are a **sieve with a verdict attached**. The verdict lives only in the source. When I finally opened AMD-006 at hour five, ⑦ went from *"a founder preference among three options"* to *"option 3 is not a legitimate choice under your own ratified amendment"* — **in one read, on a decision I had already handed over wrongly.**

**Insight.** §7.3 states the mechanism plainly and I had quoted it without hearing it: ***"The folder is the immutable record; CLAUDE.md is the derived current state."*** A derivation is a **human summary of a ratified text**, and summaries lose **force** far more readily than they lose **facts**. §1.5.1 preserved every layer's name, order and definition — and dropped the sentence that turns the framework from *guidance* into a *gate*. **That is the dangerous kind of lossy: it reads complete.** Nothing about §1.5.1 signals that something load-bearing was left upstream.

**This is a third altitude, distinct from its neighbours, and the distinction is the whole asset.** **A19**: the methodology was not in the tree. **A35/CAT-003**: the methodology was in the tree and unread. **A37**: the methodology was in the tree, and I read it — **the right-looking artifact, faithfully — and still missed the rule, because I read the derivation instead of the law.** The defense for A19 is "put it in the tree." For A35, "open it." **Neither helps here**: I did both. The defense is different — *follow the citation upstream*.

**Bounded, and the bound is what makes it dangerous.** I checked all four derivations this session: **AMD-001 → §7 faithful** (word-for-word), **AMD-004 → §1.7 faithful** (one trivial drop), **AMD-005 → §0.1 faithful**, **AMD-006 → §1.5.1 LOSSY**. One in four. **If derivations were reliably lossy you would always check; because they are reliably faithful, you never do** — and the single exception is the one carrying a shipping verdict.

**The tell.** Every amendment is born from a **failure**. If the derived clause reads like a **review lens** while the incident that produced it was a **shipped break**, force has been lost in transit. §1.5.1 reads like a checklist; AMD-006 was written the day a shipped feature broke a user's workflow, and its Addendum answers *"so what happens if a layer fails?"* — the question the checklist form never raises.

**Constitutional bearing.** Direct application of **§7.3/§7.4** — the constitution's own statement that it is *derived*, taken seriously for the first time. Completes **A19** (in the tree) and **A35** (opened) with the third condition: *the right document*. Serves **§0.1**, whose gate asks whether the methodology is *present* — presence, then reading, then **provenance**. Companion to **A22**: a `Session-Reads` entry for `§1.5.1` is honest and still insufficient, because the trailer records which *derived* text was read, never whether the *source* was consulted. Candidate §6-checklist item: *"Am I about to DECIDE something on a CLAUDE.md clause? Then open the amendment that added it — the clause names it ('Added by AMD-00X'), and the citation is a pointer, not a substitute."*

**Future-use note.** CLAUDE.md's clauses **carry their own provenance** — *"Added by [AMD-005]"*, *"Added by [AMD-006]"*, with links. Those links are not decoration; they are the difference between the rule and the record of the rule. Two rules: **(1)** when a derived clause is *load-bearing for a decision* — ship/not-ship, allowed/forbidden, my-call/founder's-call — open its amendment **before deciding**, not after. Reading it *"for context"* later is how ⑦ spent five hours mis-framed. **(2)** When a founder says *"in full,"* they are naming the source, not the summary — and the summary being accurate is exactly why the substitution feels safe.

**The lesson about the lesson.** The founder wrote the defense into the instruction — *"including AMD-006 in full"* — and I satisfied it with a summary while believing I had complied, which is §5's confident-answer-too-quickly aimed at an explicit order. **Its own test:** the next time a CLAUDE.md clause decides something, does the session open the amendment behind it — or quote the derived text, cite it precisely, and never notice that the sentence which would have changed the decision was one link away?
